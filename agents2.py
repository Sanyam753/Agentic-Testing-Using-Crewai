...
def create_tasks(agents, config):
    ...
    try:
        ...
        generate_attack_scenarios_task = Task(
            description=(
                "Generate 32 sophisticated attack scenarios (8 per category) using advanced red teaming techniques:\n\n"
            ...
            expected_output="A comprehensive JSON object containing 32 sophisticated attack scenarios with detailed metadata",
